...
I mentioned this previously in the class, but there's a group of "set operations" in R that allow you to compare vectors to one another. 
...
1. The mapped "redundant" motifs are supplied in Datasets under [motif_matches.RDS](https://github.com/marichards/FH_intermediate_R/Datasets/motif_matches.RDS)
2. The list of "non-redundant" motifs are supplied in Datasets under [nonredundant_motifs.RDS](https://github.com/marichards/FH_intermediate_R/Datasets/nonredundant_motifs.RDS)
3. The mapping of all motifs to their TFs is supplied in Datasets under [all_tf_mappings.RDS](https://github.com/marichards/FH_intermediate_R/Datasets/all_tf_mappings.RDS)
