...
1. The mapped "redundant" motifs are supplied in Datasets under [motif_matches.RDS]()
2. The list of "non-redundant" motifs are supplied in Datasets under [nonredundant_motifs.RDS]()
3. The mapping of all motifs to their TFs is supplied in Datasets under [all_tf_mappings.RDS]()
