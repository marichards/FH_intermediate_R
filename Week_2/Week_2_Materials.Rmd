...
That should do for an overview; let's get to an exercise
...
You can also take a look at the file itself to better understand its formatting. I'll post a solution after class, but I'm looking for a data frame with:
